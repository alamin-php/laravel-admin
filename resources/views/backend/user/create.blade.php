          ...
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-default">
              <div class="card-header">
                ...
                <h3 class="card-title"><i class="fa fa-plus"></i> Create User</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
             <form method="post" action="{{ route('user.add') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="inputName" placeholder="Enter full name" required="">
                  </div>                  
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info btn-sm"><i class="fa fa-save"></i> Save User Information</button>
                </div>
              </form>
            </div>
        </div>
