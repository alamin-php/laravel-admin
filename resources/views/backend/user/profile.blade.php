            ...
            <div class="card card-default">
             ...
             <form method="post" action="{{ route('user.update',$data->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="inputTextarea">About</label>
                    <textarea name="about" id="inputTextarea" cols="20" rows="5" class="form-control" placeholder="Write here about your self">{{ $data->about }}</textarea>
                  </div>
                  <div class="form-group">
